...
public class HeroClient {
	...
	/**
	 * Finds a random {@link Hero}. The retry logic is applied to the result of the {@link }, meaning that retries that return failures could trigger the breaker to open.

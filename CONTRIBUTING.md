...
Each application (`rest-fights`, `rest-heroes`, `rest-villains`, `rest-narration`, and `grpc-locations`) is a self-contained application. Details on how to run each are included in the `README.md` in each project's sub-directory.

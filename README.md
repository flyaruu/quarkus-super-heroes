...
This is a sample application demonstrating Quarkus features and best practices. The application allows superheroes to fight against supervillains across several microservices. All the data used by the applications are [on the `characterdata` branch](https://github.com/quarkusio/quarkus-super-heroes/tree/characterdata) of this repository.
...
- [Fight REST API](rest-fights) - A reactive HTTP microservice orchestrating fights, using [MongoDB](https://quarkus.io/guides/mongodb-panache) and [resilience patterns](https://quarkus.io/guides/smallrye-fault-tolerance)

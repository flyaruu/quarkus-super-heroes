...
A sample application demonstrating Quarkus features and best practices. Superheroes fight against supervillains across multiple microservices communicating via REST and gRPC.

## Architecture

The application consists of several microservices. The base JVM version for all the applications is Java 25.
